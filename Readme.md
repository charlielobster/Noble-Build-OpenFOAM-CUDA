...
The  includes configuration from source of most of the numerous external tools OpenFOAM has awareness of, such as PETSc, METIS, Scotch, FFTW, etc - as well as all the lower-level or CUDA-aware tools, such as UCX, OpenMPI, Umpire, and AMGX.
