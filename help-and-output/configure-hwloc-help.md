```text
./configure --help
`configure' configures hwloc 3.0.0a1-git to adapt to many kinds of systems.
...
Optional Features:
  ...
  --disable-rsmi          Disable the AMD/ROCm SMI device discovery
  --disable-rsmi-rocm     Disable the ROCm SMI implementation of the RSMI
                          backend
  --disable-rsmi-amd      Disable the AMD SMI implementation of the RSMI
                          backend
...
Optional Packages:
  ...
  --with-amdgpu=<dir>     Specify the AMDGPU installation directory
                          (/opt/amdgpu by default)
  --with-opencl=<dir>     Specify the OpenCL installation directory
